...
const thoughtClouds = [
  {
    title: "Engineering",
    content: "I have experience in the end-to-end development of web applications, including developing and maintaining interactive tests using Next.js.",
  ...
  {
    title: "Product",
    content: "I have experience in growth hacking and lead generation, and have developed an application with over 150 registered users and 4,000 visits.",
  ...
  {
    title: "Philosophy",
    content: "I believe in creating elegant and effective solutions to complex problems. I am passionate about building beautiful and intuitive user interfaces.",
